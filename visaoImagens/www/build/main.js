...
var TabsPage = (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/fprado/Documents/includeday7/visaoImagens/src/pages/tabs/tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Contact" tabIcon="contacts"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/Users/fprado/Documents/includeday7/visaoImagens/src/pages/tabs/tabs.html"*/
        }),
...
var AboutPage = (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"/Users/fprado/Documents/includeday7/visaoImagens/src/pages/about/about.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      About\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"/Users/fprado/Documents/includeday7/visaoImagens/src/pages/about/about.html"*/
        }),
...
var ContactPage = (function () {
    ...
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-contact',template:/*ion-inline-start:"/Users/fprado/Documents/includeday7/visaoImagens/src/pages/contact/contact.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Contact\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-list-header>Follow us on Twitter</ion-list-header>\n    <ion-item>\n      <ion-icon name="ionic" item-start></ion-icon>\n      @ionicframework\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/fprado/Documents/includeday7/visaoImagens/src/pages/contact/contact.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */]])
    ], ContactPage);
    return ContactPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_cognitive_api_cognitive_api__ = __webpack_require__(201);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = (function () {
    function HomePage(navCtrl, congnitiveProvider) {
        this.navCtrl = navCtrl;
        this.congnitiveProvider = congnitiveProvider;
        this.analyseImageTest();
    }
    HomePage.prototype.analyseImageTest = function () {
        var _this = this;
        var body = {
        ...
        this.congnitiveProvider.analyseImage(body).then(function (result) {
            ...
            if (result && result['description'] && result['description']['captions']) {
                _this.description = result['description']['captions'][0]['text'];
                _this.imagePath = 'http://images.equipboard.com/uploads/user/image/8602/big_layne-staley.jpg';
                _this.requestStatus = 'SUCESSO';
            }
        }, function (err) {
            console.log(err);
        });
...
var CognitiveApiProvider = (function () {
    function CognitiveApiProvider(http) {
        this.http = http;
        this.azureBaseUrl = 'https://westcentralus.api.cognitive.microsoft.com/vision/v1.0';
        this.azureApiKey = '0f71920e332b484284fd59fd421bca1c';
    ...
    CognitiveApiProvider.prototype.analyseImage = function (body) {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.azureBaseUrl + '/analyze?visualFeatures=Categories,Description', JSON.stringify(body), { headers: headersObj })
    ...
    CognitiveApiProvider.prototype.translateUsToBr = function () {
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_cognitive_api_cognitive_api__ = __webpack_require__(201);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__providers_cognitive_api_cognitive_api__["a" /* CognitiveApiProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
